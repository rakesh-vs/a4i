...
def create_noaa_agent():
    """Create and return the NOAA Live agent."""
    logger.info("[create_noaa_agent] Creating NOAA Live agent with tools")
    noaa_agent = Agent(
        name="noaa_agent",
    ...
    logger.info("[create_noaa_agent] NOAA Live agent created successfully")
    return noaa_agent
